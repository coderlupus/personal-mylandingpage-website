...
const MadeByHumans = () => {
  return <section id="inspiration" className="w-full bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll pb-2">
        <div className="w-full rounded-2xl sm:rounded-3xl overflow-hidden relative mt-6 sm:mt-8">
          ...
          backgroundImage: "url('/background-section3.png')"
            ...
            }} className="sm:text-4xl font-playfair text-white italic mt-0 mx-0 font-thin text-4xl md:text-5xl py-0 px-0 text-center lg:text-6xl">
                "Em breve uma citação inspiradora aqui"
              </h2>
            </div>
