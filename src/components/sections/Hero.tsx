                ...
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    >
                        <Trans
                            i18nKey="hero.title"
                            components={{
                                highlight: <span className="text-pulse-500" />
                            }}
                        />
                    </h1>
                    ...
                    >
                        ...
                        <a
                            href="#projects"
                            className="flex items-center justify-center w-full sm:w-auto text-center bg-white/80 backdrop-blur-sm text-gray-800 px-6 py-4 rounded-full font-medium border border-gray-200 hover:border-pulse-300 hover:bg-white shadow-md hover:shadow-lg transition-all duration-300"
                            style={{
                                fontSize: '14px',
                                lineHeight: '20px',
                            }}
